...
`akgashishkumargopalan@gmail.com`.

## Step 1 — Create the Google Sheet
1. Go to [sheets.google.com](https://sheets.google.com) and create a new blank spreadsheet.
2. Name it something like **"Ashish & Deepthi — RSVPs"**.
...
3. Check the inbox for `akgashishkumargopalan@gmail.com` — you should
   receive a notification email with the guest's details.
